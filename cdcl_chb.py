...
class CDCL_CHB:
    ...
    #     self.assigned_v[lit+self.num_vars] = self.num_conflicts
    ...
    #     # print(assigned_lits)
    #     interval = self.num_conflicts - self.assigned_v[assigned_lits+self.num_vars]
    #     # print(interval)
    ...
    #
    #     # for lit in literals:
    #     #     interval = self.num_conflicts - self.assigned_v[lit[0]]
    #     #     if interval > 0:
    ...
    def run(self):
        ...
        while len(self.assignment) < self.num_vars:
            ...
            while conflict_ante is not None:
                ...
                # Learn conflict.
                # time1 = time.time()
                backtrack_level, learned_clause, conflict_side = self.analyze_conflict(
                    conflict_ante)
                # time2 = time.time()
